        ...
        : IYoutubeDownloader
    {
            ...
            ProjectDirectory projectDirectory)
        {
            ...
            var bestResolutionThumbnail = videoMetadata.Thumbnail is null ?
                ...
                await DownloadThumbnailAsync(videoMetadata.Thumbnail, projectDirectory);

            var thumbnailFiles = await encodingService.EncodeThumbnailsAsync(
                bestResolutionThumbnail,
                projectDirectory.EncodedDirectory);
            ...
            ProjectDirectory projectDirectory)
        {
            ...
            var videoFilePath = Path.Combine(projectDirectory.DirPath, videoFileName);
