...
namespace Etherna.VideoImporter.Core.Utilities
{
    public class YoutubeDownloader : IYoutubeDownloader
    {
            ...
            YouTubeVideoMetadataBase videoMetadata)
        {
            ...
            // Get manifest data.
            var youtubeStreamsManifest = await youtubeClient.Videos.Streams.GetManifestAsync(videoMetadata.YoutubeUrl);
            ...
            string videoTitle)
        {
            ...
            for (int i = 0; i <= CommonConsts.DOWNLOAD_MAX_RETRY; i++)
            {
                ...
                catch { await Task.Delay(CommonConsts.DOWNLOAD_RETRY_TIMESPAN); }
            }
