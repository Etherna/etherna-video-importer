...
namespace Etherna.VideoImporter.Core.Utilities
{
        ...
        : IYoutubeDownloader
    {
        ...
        // Methods.
        public async Task<Video> BuildVideoFromMetadataAsync(YouTubeVideoMetadataBase videoMetadata)
        {
            ...
            // Get closed captions.
            var closedCaptionManifest = await YoutubeClient.Videos.ClosedCaptions.GetManifestAsync(videoMetadata.YoutubeId);
            var closedCaptionTracks = closedCaptionManifest.Tracks
                .Where(ccTrack => ccTrack.IsAutoGenerated == false).ToArray(); //include only not YT generated cc.
            ...
            var finalVideoEncoding = await encodingService.EncodeVideoAsync(
                sourceVideoEncoding,
                closedCaptionTracks.Select(cct => new ClosedCaptionTrackFile(cct.Language)).ToArray());
